<div class="flex flex-col p-4">
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class=" p-5 ">
                                    <div class="flex items-center gap-1">
                                        <button
                                            onclick="openEditModal('{{ route('manage.edit.user', ['id' => $user->id]) }}', {{ $user->name }}, {{ $user->email }}, {{ $user->role }})"
        ...
        <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md p-4">
            <form method="post" action="">
                ...
                <div class="flex items-center justify-end mt-4">
                    <a
                        href="#"
                        onclick="closeModal('UserEditModal')"
                        class="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-cyan-200 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center"
                        data-modal-toggle="delete-user-modal">
                        Cancel
                    </a>
    ...
    <script type="text/javascript">
        window.openEditModal = function (route, name, email, role) {
